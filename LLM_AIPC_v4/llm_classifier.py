...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--label-words", default="No,Yes", help="Comma-separated verbalizer words ordered by encoded label class.")
    ...
    parser.add_argument("--resume-from-checkpoint", default=None, help="Path to a checkpoint directory, for example outputs/v4/qwen_qlora/checkpoint-last.")
